switch (postCodeArea) {
  ...
  case UkPostCodeAreas.SouthEastLondon:
    return isBetween(postCodeDistrictNumber, 1, 28);
  ...
  case UkPostCodeAreas.SouthWestLondon:
    return (
      isBetween(postCodeDistrictNumber, 1, 20) || postCodeDistrictNumber === 95
    );
  ...
  case UkPostCodeAreas.WesternCentralLondon:
    return isBetween(postCodeDistrictNumber, 1, 2);
